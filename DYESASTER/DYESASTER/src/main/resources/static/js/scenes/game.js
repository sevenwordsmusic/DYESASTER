var GameScene = new Phaser.Class({
    ...
    {	 
		...
		//this.bg_Minimap = this.add.image(500,500,"bg-MP");
        ...
        this.minimapA = this.cameras.add((game.config.width/2)-225, 5, 220, 150).setZoom(0.1).setName('mini');
        this.minimapA.setBackgroundColor(0x102244);
        this.minimapA.ignore(this.bg_0);
        this.minimapA.ignore(this.bg_1);
        this.minimapA.ignore(this.bg_2);
        this.minimapA.startFollow(player[0]);
        
        this.minimapB = this.cameras.add((game.config.width/2)+5, 5, 220, 150).setZoom(0.1).setName('miniB');
        this.minimapB.setBackgroundColor(0x102244);
        this.minimapB.ignore(this.bg_0);
        this.minimapB.ignore(this.bg_1);
        this.minimapB.ignore(this.bg_2);
        this.minimapB.startFollow(player[1]);
    ...
    update: function (time, delta) {
    	//this.minimap.scrollX = Phaser.Math.Clamp(this.player[0].x - game.config.width*0.1, 800, 2000);
